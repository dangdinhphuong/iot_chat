...
- [Client](app/textalk/websocket/docs/Client.md)
- [Server](app/textalk/websocket/docs/Server.md)
- [Examples](app/textalk/websocket/docs/Examples.md)
- [Changelog](app/textalk/websocket/docs/Changelog.md)
- [Contributing](app/textalk/websocket/docs/Contributing.md)
...
The [client](app/textalk/websocket/docs/Client.md) can read and write on a WebSocket stream.
...
The library contains a rudimentary single stream/single thread [server](app/textalk/websocket/docs/Server.md).
It internally supports Upgrade handshake and implicit close and ping/pong operations.
...
[ISC License](app/textalk/websocket/COPYING.md)
